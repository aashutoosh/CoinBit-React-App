...
function NavContainer(props) {
  return <nav className="nav container">{props.children}</nav>;
}

function Links() {
  return (
    <div className="links__container">
      <div className="nav__link nav__link--watchlist">
        <a href="#watchlist">
          <span>Watchlist</span>
          <i className="ri-apps-2-line" />
        </a>
      </div>
      <div className="nav__link nav__link--alerts active">
        <a href="#">
          <span>Alerts</span>
          <i className="ri-alarm-line" />
        </a>
      </div>
      <div className="nav__link nav__link--settings">
        <a href="#settings">
          <span>Settings</span>
